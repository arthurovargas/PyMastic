...
it = 100                    # if convergence error, reduce the it
...
lg, = ax1.plot(RS["Strain_R"]*1e6, z, 'r-o')
font = {'family': 'serif',
        'weight': 'normal',
        'size': 15}
ax1.set_xlabel("MicroStrain", fontdict=font)
...
lg, = ax2.plot(df["Radial_strain"]*1e6, z, 'k-o')

ax2.set_xlabel("MicroStrain", fontdict=font)
